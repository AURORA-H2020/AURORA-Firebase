...
import type { TestContext } from "../utils/test-context";
...
describe("Firestore Security Rules", () => {
	before(async () => {
		...
		testContext = {
			...
			authenticatedContext: () =>
				testEnvironment.authenticatedContext(authenticatedContextUserId),
	...
	after(async () => {
		...
		await new Promise((resolve, reject) => {
			const { host, port } = testContext.testEnvironment.emulators
				.firestore as HostAndPort;
	...
	describe("/users/pv-investments", () => {
		...
		describe("Authorized User", () => {
			...
			it("Allow to update a pv investment", async () => {
				const pvInvestmentId = generateRandomString();
				await testContext.testEnvironment.withSecurityRulesDisabled((context) =>
					context
						.firestore()
						.collection("users")
	...
	describe("/users/recommendations", () => {
		describe("Unauthorized User", () => {
			it("Deny to read a single recommendation", () =>
				assertFails(
					testContext
						.unauthenticatedContext()
						.firestore()
			...
			it("Deny to list all recommendations", () =>
				assertFails(
					testContext
						.unauthenticatedContext()
						.firestore()
			...
			it("Deny to create a recommendation", () =>
				assertFails(
					testContext
						.unauthenticatedContext()
						.firestore()
			...
			it("Deny to update a recommendation", () =>
				assertFails(
					testContext
						.unauthenticatedContext()
						.firestore()
			...
			it("Deny to delete a recommendation", () =>
				assertFails(
					testContext
						.unauthenticatedContext()
						.firestore()
		...
		describe("Authorized User", () => {
			it("Allow to read a single recommendation if auth uid matches", () =>
				assertSucceeds(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Deny to read a single recommendation if auth uid not matches", () =>
				assertFails(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Allow to list all recommendations if auth uid matches", () =>
				assertSucceeds(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Deny to list all recommendations if auth uid not matches", () =>
				assertFails(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Allow to create a recommendation if auth uid matches", () =>
				assertSucceeds(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Deny to create a recommendation if auth uid not matches", () =>
				assertFails(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Allow to update a recommendation", async () => {
				const recommendationId = generateRandomString();
				await testContext.testEnvironment.withSecurityRulesDisabled((context) =>
					context
						.firestore()
						.collection("users")
			...
			it("Deny to update a recommendation if auth uid not matches", () =>
				assertFails(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Allow to delete a recommendation if auth uid matches", () =>
				assertSucceeds(
					testContext
						.authenticatedContext()
						.firestore()
			...
			it("Deny to delete a recommendation if auth uid not matches", () =>
				assertFails(
					testContext
						.authenticatedContext()
						.firestore()
